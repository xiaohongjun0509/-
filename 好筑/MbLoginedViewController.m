...
@interface MbLoginedViewController ()<UIAlertViewDelegate>
...
@property(nonatomic,strong)MbModifyViewController* modifyVC;
@end

@implementation MbLoginedViewController
...
-(void)onCreate{
    ...
    //修改密码
    self.modifyBtn = [[UIButton alloc]initWithFrame:CGRectMake(20, 130, viewWidth-40, 40)];
    ...
    //退出登录
    self.exitBtn = [[UIButton alloc]initWithFrame:CGRectMake(20, 190, viewWidth-40, 40)];
    ...
    //LOGO
    self.logo = [[UIImageView alloc]initWithFrame:CGRectMake(viewWidth/4, CGRectGetMaxY(self.exitBtn.frame)+20, viewWidth/2, viewWidth/2/1.2)];
...
-(void)modifyBtn:(UIButton*)sender{
    ...
    self.modifyVC = [[MbModifyViewController alloc]init];
