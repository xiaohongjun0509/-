...
//@property(nonatomic,strong)MbReViewController* reView;                  //我的发布页
...
//        
//    }else if (![self.addeduArrayStr containsObject:self.jsonString1]){
...
//    }else if (indexPath.section==0&&indexPath.row==7){
        ...
        self.line7 = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.workExperience.frame)+15, 10, 1, self.workExperience.frame.size.height+10)];
        self.line7.backgroundColor = [UIColor colorWithRed:205/255.0 green:205/255.0 blue:205/255.0 alpha:1];
        ...
        self.workExperienceDetail.frame = CGRectMake(CGRectGetMaxX(self.line7.frame)+15, 15, workExperienceDetailSize.width, workExperienceDetailSize.height);
...
//            if (self.addeduArray.count>0) {
//                [self.addeduArray removeObjectAtIndex:indexPath.row-1];//移除数据源的数据
//                [tableView deleteRowsAtIndexPaths:[NSArray arrayWithObject:indexPath] withRowAnimation:UITableViewRowAnimationLeft];//移除tableView中的数据
//            }
//        }else if (indexPath.section==2){
//            if (self.addworkArray.count>0) {
//            [self.addworkArray removeObjectAtIndex:indexPath.row-1];//移除数据源的数据
//            [tableView deleteRowsAtIndexPaths:[NSArray arrayWithObject:indexPath] withRowAnimation:UITableViewRowAnimationLeft];//移除tableView中的数据
//            }
//        }
//    }
...
//    [JZQHttpTools postWithPath:sendjianli params:@{@"userid":@8,@"title":@"fdgsgg",@"username":@"王大辉",@"age":@23,@"sex":@1,@"diploma":@"dfgdfdb",@"experience":@"3年",@"position":@"工程师",@"wages":@"8000",@"phone":@"15133333333",@"intruduction":@"好看十多个"} success:^(id JSON) {
//        
//        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:JSON[@"return"] message:nil delegate:self cancelButtonTitle:@"好" otherButtonTitles:nil, nil];
//        [alert show];
...
// [MbPaser sendResumeInformationByUserid:self.userid introduces:self.titleDetail.text name:self.name.text sex:1 age:age education:self.educationBtn.titleLabel.text experience:self.yearsBtn.titleLabel.text position:self.typeBtn.titleLabel.text salary:self.moneyBtn.titleLabel.text telephone:self.telephoneField.text eduArray:self.addeduArray workArray:self.addworkArray jieshao:self.introduction.text result:^(ResumeSaveResponse *response, NSError *error)
...
//        }
//    }else if (textField == self.introduction){
