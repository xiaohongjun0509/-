//
//  MbEnterpriseinformationViewController.m
//  Recruitment
//
...
@interface MbEnterpriseinformationViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UIAlertViewDelegate,UIScrollViewDelegate,UITextViewDelegate>
{
    CGSize labelSize;
...
@property(nonatomic,strong)MbReViewController* reView;
@end

@implementation MbEnterpriseinformationViewController
