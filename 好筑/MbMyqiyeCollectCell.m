...
#import "JZQCommon.h"
@implementation MbMyqiyeCollectCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        CGSize nameSize = [self.nameLabel.text sizeWithFont:self.nameLabel.font constrainedToSize:CGSizeMake(400, 400) lineBreakMode:NSLineBreakByWordWrapping];
        ...
        //选中按钮
        //self.seleteImage = [[UIImageView alloc]initWithFrame:CGRectMake(viewWidth-17-placeSize.height, CGRectGetMaxY(self.nameLabel.frame) + 7, placeSize.height+2, placeSize.height+2)];
        //[self addSubview:self.seleteImage];
        //对号按钮
        //self.seleteBtn = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth-17-placeSize.height, CGRectGetMaxY(self.nameLabel.frame) + 7, placeSize.height+2, placeSize.height+2)];
        ...
        //[self.seleteBtn addTarget:self action:@selector(seletedBtn3:) forControlEvents:UIControlEventTouchUpInside];
...
//    if (self.delegate && [self.delegate respondsToSelector:@selector(seletedBtn3:)])
//    {
//        [self.delegate performSelector:@selector(seletedBtn3:) withObject:sender];
//    }
