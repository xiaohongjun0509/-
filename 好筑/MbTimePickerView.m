...
-(void)onCreate
{
    _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 0, viewWidth-30, 40)];
    ...
    //横线
    _line = [[UILabel alloc]initWithFrame:CGRectMake(0, 41, viewWidth, 1)];
    ...
    _monthPicker.frame = CGRectMake(0, 41, viewWidth, 216);
...
//    _datePicker.tag = 6003;
//    _datePicker.frame = CGRectMake(0, 41, viewWidth, self.frame.size.height - 145);
//    [self addSubview:_datePicker];
//横线2
    _line2 = [[UILabel alloc]initWithFrame:CGRectMake(0, self.frame.size.height-105, viewWidth, 1)];
    ...
    cancelBtn.frame = CGRectMake(0, self.frame.size.height-104, viewWidth/2, 40);
    cancelBtn.tag = 6004;
    ...
    ensureBtn.frame = CGRectMake(viewWidth/2, self.frame.size.height-104, viewWidth/2, 40);
    ensureBtn.tag = 6005;
