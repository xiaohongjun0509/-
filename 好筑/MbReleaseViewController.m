...
#import "MbEnterpriseinformationViewController.h"
...
- (void)viewDidLoad {
    ...
    if (viewHeight==480) {
        //求职简历
        self.btn1 = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2-viewHeight/10, viewHeight/20-5, viewHeight/5, viewHeight/5)];
        ...
        self.btn1.layer.cornerRadius = viewHeight/10;
        ...
        //职位招聘
        self.btn2 = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2-viewHeight/10, viewHeight/5+viewHeight/10-7, viewHeight/5, viewHeight/5)];
        ...
        self.btn2.layer.cornerRadius = viewHeight/10;
        ...
        //企业信息
        self.btn3 = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2-viewHeight/10, viewHeight/2.5+viewHeight/20*3-10, viewHeight/5, viewHeight/5)];
        ...
        self.btn3.layer.cornerRadius = viewHeight/10;
    ...
    //求职简历
    self.btn1 = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2-viewHeight/10, viewHeight/20, viewHeight/5, viewHeight/5)];
    [self.btn1 setBackgroundColor:[UIColor colorWithRed:44/255.0 green:214/255.0 blue:202/255.0 alpha:1]];
    [self.btn1 addTarget:self action:@selector(jianli:) forControlEvents:UIControlEventTouchUpInside];
    self.btn1.userInteractionEnabled = YES;
    self.btn1.layer.cornerRadius = viewHeight/10;
    ...
    [self.btn1 addSubview:self.label1];
    //职位招聘
    self.btn2 = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2-viewHeight/10, viewHeight/5+viewHeight/10, viewHeight/5, viewHeight/5)];
    [self.btn2 setBackgroundColor:[UIColor colorWithRed:0 green:224/255.0 blue:249/255.0 alpha:1]];
    [self.btn2 addTarget:self action:@selector(zhaopin:) forControlEvents:UIControlEventTouchUpInside];
    self.btn2.userInteractionEnabled = YES;
    self.btn2.layer.cornerRadius = viewHeight/10;
    ...
    //企业信息
    self.btn3 = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2-viewHeight/10, viewHeight/2.5+viewHeight/20*3, viewHeight/5, viewHeight/5)];
    [self.btn3 setBackgroundColor:[UIColor colorWithRed:74/255.0 green:121/255.0 blue:247/255.0 alpha:1]];
    [self.btn3 addTarget:self action:@selector(xinxi:) forControlEvents:UIControlEventTouchUpInside];
    self.btn3.userInteractionEnabled = YES;
    self.btn3.layer.cornerRadius = viewHeight/10;
...
-(void)viewWillAppear:(BOOL)animated{
   ...
   self.cityName = [[MbDanli sharedManager] cityName];
