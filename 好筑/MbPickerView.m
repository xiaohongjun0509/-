...
{
    //选择学历
    UILabel* label = [[UILabel alloc]initWithFrame:CGRectMake(15, 0, viewWidth - 30, 40)];
    label.text = @"选择学历";
    label.font = [UIFont systemFontOfSize:labelText];
    label.textColor = [UIColor blackColor];
    [self addSubview:label];
    
    line1 = [[UILabel alloc]initWithFrame:CGRectMake(0, 40, viewWidth, 1)];
    line1.backgroundColor = [UIColor colorWithRed:247/255.0 green:114/255.0 blue:111/255.0 alpha:1];
    [self addSubview:line1];
    //pickerView
    self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 41, viewWidth, 180)];
    ...
    //横线2
    line2 = [[UILabel alloc]initWithFrame:CGRectMake(0, 221, viewWidth, 1)];
    line2.backgroundColor = [UIColor colorWithRed:191/255.0 green:191/255.0 blue:191/255.0 alpha:1];
    [self addSubview:line2];
    
    //取消按钮
    self.cancleBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 222, viewWidth/2, 40)];
    ...
    //确定按钮
    self.sureBtn = [[UIButton alloc]initWithFrame:CGRectMake(viewWidth/2, 222, viewWidth/2, 40)];
