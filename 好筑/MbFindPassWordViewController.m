...
@interface MbFindPassWordViewController ()<UIAlertViewDelegate>
...
//    [self.view addSubview:self.userName];
    //竖线1
//    self.verticalLine1 = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.userName.frame)+10, 8, 1, self.userNameImage.frame.size.height+4)];
...
//    [self.view addSubview:self.verticalLine1];
    ...
    //横线1
//    self.transverseLine1 = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.verticalLine1.frame)+8, viewWidth, 1)];
//    self.transverseLine1.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.transverseLine1];
    
    
    
    //验证码
//    self.safeWord = [[UILabel alloc]init];
//    self.safeWord.text = @"验证码";
...
//    self.safeWord.frame = CGRectMake(CGRectGetMaxX(self.safeWordImage.frame)+10, CGRectGetMaxY(self.transverseLine1.frame) + 12, safeWordSize.width, safeWordSize.height);
//    [self.view addSubview:self.safeWord];
    //竖线2
//    self.verticalLine2 = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.safeWord.frame)+10, CGRectGetMaxY(self.transverseLine1.frame)+8, 1, self.safeWordImage.frame.size.height+4)];
//    self.verticalLine2.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.verticalLine2];
    ...
    //横线2
//    self.transverseLine2 = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.verticalLine2.frame)+8, viewWidth, 1)];
//    self.transverseLine2.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.transverseLine2];
...
//    self.passWord.frame = CGRectMake(CGRectGetMaxX(self.passWordImage.frame)+10, CGRectGetMaxY(self.transverseLine2.frame) + 12, safeWordSize.width, safeWordSize.height);
//    [self.view addSubview:self.passWord];
    //竖线3
//    self.verticalLine3 = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.passWord.frame)+10, CGRectGetMaxY(self.transverseLine2.frame)+8, 1, self.passWordImage.frame.size.height+4)];
//    self.verticalLine3.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.verticalLine3];
    
    self.passWordField = [[UITextField alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.passWordImage.frame)+10, CGRectGetMaxY(self.line2.frame) + 10, viewWidth/3*2, 25)];
    ...
    //横线3
//    self.transverseLine3 = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.verticalLine3.frame)+8, viewWidth, 1)];
//    self.transverseLine3.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.transverseLine3];
    
    
    
    //新密码1
//    self.passWord1 = [[UILabel alloc]init];
//    self.passWord1.text = @"新密码";
//    self.passWord1.textColor = [UIColor whiteColor];
//    self.passWord1.font = [UIFont systemFontOfSize:labelText];
//    CGSize passWord1Size = [self.passWord1.text sizeWithFont:self.passWord1.font constrainedToSize:CGSizeMake(100, 100) lineBreakMode:NSLineBreakByCharWrapping];
    
//    self.passWordImage1 = [[UIImageView alloc]initWithFrame:CGRectMake(20, CGRectGetMaxY(self.line3.frame) + 12.5, 20, 20)];
//    self.passWordImage1.image = [UIImage imageNamed:@"tubiao.png"];
//    [self.view1 addSubview:self.passWordImage1];
    
//    self.passWord1.frame = CGRectMake(CGRectGetMaxX(self.passWordImage1.frame)+10, CGRectGetMaxY(self.transverseLine3.frame) + 12, safeWordSize.width, safeWordSize.height);
//    [self.view addSubview:self.passWord1];
    //竖线4
//    self.verticalLine4 = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.passWord1.frame)+10, CGRectGetMaxY(self.transverseLine3.frame)+8, 1, self.passWordImage1.frame.size.height+4)];
//    self.verticalLine4.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.verticalLine4];
    
//    self.passWordField1 = [[UITextField alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.passWordImage1.frame)+10, CGRectGetMaxY(self.line3.frame) + 10, viewWidth/3*2, 25)];
//    self.passWordField1.textColor = [UIColor blackColor];
//    self.passWordField1.font = [UIFont systemFontOfSize:labelText];
//    self.passWordField1.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
//    self.passWordField1.placeholder = @"请再次输入新密码";
//    [self.passWordField1 setValue:[UIFont systemFontOfSize:labelText] forKeyPath:@"_placeholderLabel.font"];
//    [self.passWordField1 setValue:[UIColor colorWithRed:227/255.0 green:227/255.0 blue:229/255.0 alpha:1] forKeyPath:@"_placeholderLabel.textColor"];
//    [self.view1 addSubview:self.passWordField1];
    //横线4
//    self.transverseLine4 = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.verticalLine4.frame)+8, viewWidth, 1)];
//    self.transverseLine4.backgroundColor = [UIColor whiteColor];
//    [self.view addSubview:self.transverseLine4];
    
    
    //注册按钮
    

    self.findAndLogin = [[UIButton alloc]initWithFrame:CGRectMake(20, 180, viewWidth-40, 40)];
...
//    if (viewHeight==480) {
//        self.logo = [[UIImageView alloc]initWithFrame:CGRectMake(70, CGRectGetMaxY(self.findAndLogin.frame)+10, viewWidth-140, (viewWidth-140)/1.2)];
//        self.logo.image = [UIImage imageNamed:@"LOGO.png"];
//        
//        [self.view addSubview:self.logo];
//    }else{
        self.logo = [[UIImageView alloc]initWithFrame:CGRectMake(viewWidth/4, CGRectGetMaxY(self.findAndLogin.frame)+20, viewWidth/2, viewWidth/2/1.2)];
        self.logo.image = [UIImage imageNamed:@"LOGO.png"];
